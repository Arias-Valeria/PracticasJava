...
public class Merge {
  ...
  public ArrayList<Integer> ordenaMerge(ArrayList<Integer> data) {
    ...
    if (result.size() == 1) {
      ...
      //caso recursivo
      ArrayList<Integer> parcial1 = new ArrayList<Integer>(), parcial2 = new ArrayList<Integer>();
      int j = 0;
      ...
      result = this.union(this.ordenaMerge(parcial1), this.ordenaMerge(parcial2));
    }
  ...
  public ArrayList<Integer> union(ArrayList<Integer> p1, ArrayList<Integer> p2) {
    ...
    while (index1 < maxIndex1 || index2 < maxIndex2) {
      ...
      if (index1 == maxIndex1) {
        ...
        result.add((p1.get(index1) < p2.get(index2)) ? p1.get(index1++) : p2.get(index2++));
      }
    }
    return result;
  }
