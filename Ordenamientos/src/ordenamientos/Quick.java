...
public class Quick {
  ...
  public ArrayList<Integer> ordenaQuick(ArrayList<Integer> data, int l1, int l2) {
    ...
    if (l1 >= l2) {
      ...
      result = ordenaQuick(data, l1, l1aux - 1);//Ordena la parte menor.
      result = ordenaQuick(data, l1aux + 1, l2);//Ordena la parte mayor.
    }
    System.out.println(result);
    return result;
  }
